...
export type FetchCoursesQuery = { fetchCourses: Array<{ courseId: string | null, courseName: string | null, description: string | null, isEnrolled: boolean | null, thumbnail_image_path: string | null, isActive: boolean | null, createdBy: { profile_image_path: string | null, userId: string | null, username: string | null } | null, enrollments: Array<{ enrolledAt: string | null, enrollmentId: string | null, isActive: boolean | null } | null> | null, lessons: Array<{ description: string | null, lessonId: string | null, lessonName: string | null, sortOrder: number | null, videoLink: string | null } | null> | null, quizzes: Array<{ quizId: string | null, quizName: string | null } | null> | null } | null> | null };
