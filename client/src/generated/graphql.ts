...
export type FetchProfileQuery = { fetchProfile: { collegeName: string, email: string, profile_image_path: string | null, username: string, courses: Array<{ courseId: string | null, courseName: string | null, isActive: boolean | null } | null> | null, results: Array<{ resultId: string | null, score: number | null, quiz: { quizName: string | null, quizId: string | null } | null } | null> | null, role: { roleId: string | null, roleName: string | null } | null } | null };
