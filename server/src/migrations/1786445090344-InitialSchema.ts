...
export class InitialSchema1786445090344 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "results" ADD CONSTRAINT "FK_14692d0f6cd2551c499a14714e3" FOREIGN KEY ("quiz_id") REFERENCES "quizzes"("quiz_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
